...
export default function TestimonialSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[80vh] py-20 px-6 bg-gradient-to-r from-green-50 to-green-100 gap-12">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-12">
        ...
        >
          <img
            ...
            alt="Happy farmer"
            className="w-full max-w-md h-full object-cover rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300"
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center text-center h-full justify-center">
          <div className="relative w-full max-w-lg h-full flex items-center justify-center">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute w-full p-8 rounded-2xl shadow-2xl bg-white border border-gray-200 flex flex-col items-center text-center"
          ...
          <div className="flex items-center gap-4 mt-8">
            <motion.button
              className="p-3 rounded-full bg-white hover:bg-green-500 transition-all shadow-md hover:shadow-lg"
